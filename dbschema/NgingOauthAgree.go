...
type Slice_NgingOauthAgree = factory.Slicex[*NgingOauthAgree]
...
func (a *NgingOauthAgree) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingOauthAgree) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*NgingOauthAgree:
			err = a.base.FireReaded(a, queryParam, Slice_NgingOauthAgree(*v))
		case []*NgingOauthAgree:
			err = a.base.FireReaded(a, queryParam, Slice_NgingOauthAgree(v))
		case factory.Ranger:
...
func (a *NgingOauthAgree) Clone() *NgingOauthAgree {
	cloned := NgingOauthAgree{Uid: a.Uid, AppId: a.AppId, Scopes: a.Scopes, Created: a.Created, Updated: a.Updated}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingOauthAgree) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingOauthAgree) TrimOverflowText(column string, value string) string {
