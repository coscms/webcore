...
type Slice_NgingFileThumb = factory.Slicex[*NgingFileThumb]
...
func (a *NgingFileThumb) Trans() factory.Transactioner {
	return a.base.Trans()
}

func (a *NgingFileThumb) Use(trans factory.Transactioner) factory.Model {
	a.base.Use(trans)
	return a
}
...
func (a *NgingFileThumb) ConnID() int {
...
func (a *NgingFileThumb) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingFileThumb) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		switch v := recv.(type) {
		case *[]*NgingFileThumb:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFileThumb(*v))
		case []*NgingFileThumb:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFileThumb(v))
		case factory.Ranger:
...
func (a *NgingFileThumb) UpdatexField(mw func(db.Result) db.Result, field string, value interface{}, args ...interface{}) (affected int64, err error) {
...
func (a *NgingFileThumb) UpdatexFields(mw func(db.Result) db.Result, kvset map[string]interface{}, args ...interface{}) (affected int64, err error) {
...
func (a *NgingFileThumb) Clone() *NgingFileThumb {
	cloned := NgingFileThumb{Id: a.Id, FileId: a.FileId, Size: a.Size, Width: a.Width, Height: a.Height, Dpi: a.Dpi, SaveName: a.SaveName, SavePath: a.SavePath, ViewUrl: a.ViewUrl, UsedTimes: a.UsedTimes, Md5: a.Md5}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingFileThumb) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingFileThumb) TrimOverflowText(column string, value string) string {
