...
type Slice_NgingFileMoved = factory.Slicex[*NgingFileMoved]
...
func (a *NgingFileMoved) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingFileMoved) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		switch v := recv.(type) {
		case *[]*NgingFileMoved:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFileMoved(*v))
		case []*NgingFileMoved:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFileMoved(v))
		case factory.Ranger:
...
func (a *NgingFileMoved) Clone() *NgingFileMoved {
	cloned := NgingFileMoved{Id: a.Id, FileId: a.FileId, From: a.From, To: a.To, ThumbId: a.ThumbId, Created: a.Created}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingFileMoved) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingFileMoved) TrimOverflowText(column string, value string) string {
