...
type Slice_NgingAlertRecipient = factory.Slicex[*NgingAlertRecipient]
...
func (a *NgingAlertRecipient) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingAlertRecipient) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*NgingAlertRecipient:
			err = a.base.FireReaded(a, queryParam, Slice_NgingAlertRecipient(*v))
		case []*NgingAlertRecipient:
			err = a.base.FireReaded(a, queryParam, Slice_NgingAlertRecipient(v))
		case factory.Ranger:
...
func (a *NgingAlertRecipient) Clone() *NgingAlertRecipient {
	cloned := NgingAlertRecipient{Id: a.Id, Name: a.Name, Account: a.Account, Extra: a.Extra, Type: a.Type, Platform: a.Platform, Description: a.Description, Disabled: a.Disabled, Created: a.Created, Updated: a.Updated}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingAlertRecipient) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingAlertRecipient) TrimOverflowText(column string, value string) string {
