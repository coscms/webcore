...
type Slice_NgingConfig = factory.Slicex[*NgingConfig]
...
func (a *NgingConfig) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingConfig) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		switch v := recv.(type) {
		case *[]*NgingConfig:
			err = a.base.FireReaded(a, queryParam, Slice_NgingConfig(*v))
		case []*NgingConfig:
			err = a.base.FireReaded(a, queryParam, Slice_NgingConfig(v))
		case factory.Ranger:
...
func (a *NgingConfig) Clone() *NgingConfig {
	cloned := NgingConfig{Key: a.Key, Group: a.Group, Label: a.Label, Value: a.Value, Description: a.Description, Type: a.Type, Sort: a.Sort, Disabled: a.Disabled, Encrypted: a.Encrypted, Updated: a.Updated}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingConfig) GetField(field string) interface{} {
	switch field {
	case "Key":
		return a.Key
	case "Group":
...
func (a *NgingConfig) GetAllFieldNames() []string {
	return []string{
		"Key",
		"Group",
		"Label",
...
func (a *NgingConfig) HasField(field string) bool {
	switch field {
	case "Key":
		return true
	case "Group":
...
func (a *NgingConfig) ListPageByOffset(cond *db.Compounds, sorts ...interface{}) error {
	return pagination.ListPageByOffset(a, cond, sorts...)
}

func (a *NgingConfig) ListPageByOffsetAs(recv interface{}, cond *db.Compounds, sorts ...interface{}) error {
...
func (a *NgingConfig) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingConfig) TrimOverflowText(column string, value string) string {
