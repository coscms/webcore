...
type Slice_NgingCodeVerification = factory.Slicex[*NgingCodeVerification]
...
func (a *NgingCodeVerification) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingCodeVerification) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*NgingCodeVerification:
			err = a.base.FireReaded(a, queryParam, Slice_NgingCodeVerification(*v))
		case []*NgingCodeVerification:
			err = a.base.FireReaded(a, queryParam, Slice_NgingCodeVerification(v))
		case factory.Ranger:
...
func (a *NgingCodeVerification) Clone() *NgingCodeVerification {
	cloned := NgingCodeVerification{Id: a.Id, Code: a.Code, Created: a.Created, OwnerId: a.OwnerId, OwnerType: a.OwnerType, Used: a.Used, Purpose: a.Purpose, Start: a.Start, End: a.End, Disabled: a.Disabled, SendMethod: a.SendMethod, SendTo: a.SendTo}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingCodeVerification) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingCodeVerification) TrimOverflowText(column string, value string) string {
