...
CREATE TABLE `nging_cloud_backup` (
  ...
  `match_rule` varchar(200) COLLATE NOCASE NOT NULL DEFAULT '',
  `wait_fill_completed` char(1) COLLATE NOCASE NOT NULL DEFAULT 'N',
  `min_modify_interval` int NOT NULL DEFAULT '0',
  `ignore_wait_rule` varchar(200) COLLATE NOCASE NOT NULL DEFAULT '',
  `delay` int NOT NULL DEFAULT '0',
  `storage_engine` char(6) COLLATE NOCASE NOT NULL DEFAULT 's3',
  `storage_config` varchar(1000) COLLATE NOCASE NOT NULL DEFAULT '',
  ...
  `disabled` char(1) COLLATE NOCASE NOT NULL DEFAULT 'N',
  `log_disabled` char(1) COLLATE NOCASE NOT NULL DEFAULT 'N',
  `log_type` char(5) COLLATE NOCASE NOT NULL DEFAULT 'all',
  `created` int NOT NULL DEFAULT '0',
  `updated` int NOT NULL DEFAULT '0'
);
CREATE TABLE `nging_cloud_backup_log` (
  `id` integer PRIMARY KEY ,
  `backup_id` int NOT NULL DEFAULT '0',
  `backup_type` char(6) COLLATE NOCASE NOT NULL DEFAULT 'change',
  `backup_file` varchar(255) COLLATE NOCASE NOT NULL DEFAULT '',
  `remote_file` varchar(255) COLLATE NOCASE NOT NULL DEFAULT '',
  `operation` char(6) COLLATE NOCASE NOT NULL DEFAULT 'none',
...
CREATE INDEX IF NOT EXISTS `IDX_nging_cloud_backup_log_cloud_backup_log_backup_id_created` ON `nging_cloud_backup_log`(`backup_id`,`created`);
...
CREATE INDEX IF NOT EXISTS `IDX_nging_code_verification_code_verification_disabled_owner` ON `nging_code_verification`(`disabled`,`owner_type`,`owner_id`,`send_method`,`send_to`,`code`,`purpose`);
...
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_name` ON `nging_file`(`save_name`,`name`);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_used_times` ON `nging_file`(`used_times`);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_size` ON `nging_file`(`size` DESC);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_status` ON `nging_file`(`status`);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_updated` ON `nging_file`(`updated` DESC);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_view_url` ON `nging_file`(`view_url`);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_type` ON `nging_file`(`type`);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_sort` ON `nging_file`(`sort`);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_created` ON `nging_file`(`created`);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_owner_type_and_id` ON `nging_file`(`owner_type`,`owner_id`);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_width_height` ON `nging_file`(`width` DESC,`height` DESC);
CREATE INDEX IF NOT EXISTS `IDX_nging_file_file_storer` ON `nging_file`(`storer_name`,`storer_id`);
...
CREATE TABLE `nging_kv` (
  ...
  `help` varchar(1000) COLLATE NOCASE NOT NULL DEFAULT '',
...
CREATE TABLE `nging_login_log` (
  ...
  `auth_type` varchar(30) COLLATE NOCASE NOT NULL DEFAULT 'password',
...
CREATE INDEX IF NOT EXISTS `IDX_nging_login_log_login_log_username` ON `nging_login_log`(`username`);
...
CREATE TABLE `nging_oauth_agree` (
  `uid` int NOT NULL,
  `app_id` varchar(32) COLLATE NOCASE NOT NULL,
  `scopes` varchar(500) COLLATE NOCASE NOT NULL,
  `created` int NOT NULL DEFAULT '0',
  `updated` int NOT NULL DEFAULT '0'
);
CREATE UNIQUE INDEX IF NOT EXISTS `UNQ_nging_oauth_agree_oauth_agree_uniqid` ON `nging_oauth_agree`(`uid`,`app_id`);
CREATE TABLE `nging_oauth_app` (
  `id` integer PRIMARY KEY ,
  `app_id` varchar(32) COLLATE NOCASE NOT NULL,
  `app_secret` varchar(32) COLLATE NOCASE NOT NULL,
  `site_name` varchar(30) COLLATE NOCASE NOT NULL,
  `site_description` varchar(255) COLLATE NOCASE NOT NULL,
  `site_domains` varchar(500) COLLATE NOCASE NOT NULL DEFAULT '',
  `scopes` varchar(500) COLLATE NOCASE NOT NULL DEFAULT '',
  `group_id` int NOT NULL DEFAULT '0',
  `disabled` char(1) COLLATE NOCASE NOT NULL DEFAULT 'N',
  `created` int NOT NULL,
  `updated` int NOT NULL DEFAULT '0'
);
CREATE INDEX IF NOT EXISTS `IDX_nging_oauth_app_oauth_app_disabled` ON `nging_oauth_app`(`disabled`);
CREATE UNIQUE INDEX IF NOT EXISTS `UNQ_nging_oauth_app_oauth_app_app_id` ON `nging_oauth_app`(`app_id`);
...
CREATE TABLE `nging_user_oauth` (
  `id` integer PRIMARY KEY ,
  `uid` int NOT NULL,
  `name` varchar(30) COLLATE NOCASE NOT NULL DEFAULT '',
  `nick_name` varchar(30) COLLATE NOCASE NOT NULL DEFAULT '',
  `union_id` varchar(100) COLLATE NOCASE NOT NULL DEFAULT '',
  `open_id` varchar(100) COLLATE NOCASE NOT NULL DEFAULT '',
  `type` varchar(30) COLLATE NOCASE NOT NULL DEFAULT 'nging',
  `avatar` varchar(200) COLLATE NOCASE NOT NULL DEFAULT '',
  `email` varchar(100) COLLATE NOCASE NOT NULL DEFAULT '',
  `mobile` varchar(20) COLLATE NOCASE NOT NULL DEFAULT '',
  `access_token` varchar(2000) COLLATE NOCASE NOT NULL DEFAULT '',
  `refresh_token` varchar(2000) COLLATE NOCASE NOT NULL DEFAULT '',
  `expired` int NOT NULL DEFAULT '0',
  `created` int NOT NULL DEFAULT '0',
  `updated` int NOT NULL DEFAULT '0'
);
CREATE UNIQUE INDEX IF NOT EXISTS `UNQ_nging_user_oauth_user_oauth_uniqid` ON `nging_user_oauth`(`uid`,`union_id`,`open_id`,`type`);
...
CREATE TABLE `nging_user_u2f` (
  ...
  `precondition` varchar(255) COLLATE NOCASE NOT NULL DEFAULT '',
  `created` int NOT NULL DEFAULT '0'
);
CREATE INDEX IF NOT EXISTS `IDX_nging_user_u2f_user_u2f_uid_type_step` ON `nging_user_u2f`(`uid`,`type`,`step`);
