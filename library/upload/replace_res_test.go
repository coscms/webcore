...
func TestEmbedded(t *testing.T) {
	...
	capture := []string{}
	results := ParseEmbeddedRes(content, func(file string, _ uint64) {
...
func TestRelated(t *testing.T) {
	var files []string
	var fids []uint64
	ParseRelatedRes(`http://www.admpub.com/test/1.jpg#FileID-1`, func(file string, fid uint64) {
	...
	test.Eq(t, []uint64{1}, fids)
}

func TestRelated2(t *testing.T) {
	var files []string
	var fids []uint64
	ParseRelatedRes(`http://www.admpub.com/test/1.jpg,http://www.admpub.com/test/2.jpg`, func(file string, fid uint64) {
		files = append(files, file)
		fids = append(fids, fid)
	}, `,`)
